...
@section('title')
	<title>Panca Logam | Standar {!! $titlePage !!} {{ $layanan->nama }}</title>
@endsection
...
@section('style')
	...
	<link rel="stylesheet" type="text/css" href="{{ asset('amadeo/css/standar-list-view.css') }}">
@endsection
...
@section('body')
	...
	<div id="item-content">
		<img id="left" class="teksture" src="{{ asset('amadeo/images-base/tekstur.png') }}">
		<img id="right" class="teksture" src="{{ asset('amadeo/images-base/tekstur.png') }}">
